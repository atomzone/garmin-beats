...
//   - Rule: do NOT call StorageManager.{load,save,remove}("SYNC"|"LOCAL_PL_CK"|
...
class _SyncStateStore {
    ...
    static function removalAll() as Void {
        StorageManager.remove(PL_KEY);
        StorageManager.remove(TR_KEY);
    }
}
