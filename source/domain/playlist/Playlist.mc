...
class Playlist {
    ...
    function initialize(assets as Array<XAudioAsset>, playFromIndex as Number) {
        _assets = assets;
    ...
    function getAssetByIndex(index as Number) as XAudioAsset {
